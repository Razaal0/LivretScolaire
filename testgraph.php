...
$matieres = array("Mathematiques", "Langue vivante 1", "Culture G", "Culture juridique economique et manageriale", "bloc 1", "bloc 2 SLAM/SISR", "bloc 3 cybersecurite", "CEJM Appliquee", "Mat10", "Mat11", "Mat12", "Mat13");
$notes = array(random_int(0, 20), random_int(0, 20), random_int(0, 20), random_int(0, 20), random_int(0, 20), random_int(0, 20), random_int(0, 20), random_int(0, 20), random_int(0, 20), random_int(0, 20), random_int(0, 20), random_int(0, 20));
